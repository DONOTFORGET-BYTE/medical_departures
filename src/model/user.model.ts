...
export function createUsersTable(){
    var sql = "CREATE TABLE IF NOT EXISTS users(user_id int NOT NULL AUTO_INCREMENT PRIMARY KEY, email VARCHAR(255) NOT NULL UNIQUE, password VARCHAR(255) not null)";
